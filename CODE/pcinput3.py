...
while True:
    ...
    for z in range(0,50):
        ...
        if t>23:
            ...
            led1.fillRect(z,0,1,t,color=(0,255,50))
            led2.fillRect(z,0,1,t-11,color=(0,255,50))    
        elif t>15:
            led1.fillRect(z,0,1,t,color=(0,0,255))
            led2.fillRect(z,0,1,t-11,color=(0,0,255))
        elif t>12:
            led1.fillRect(z,0,1,t,color=(255,0,255))
            led2.fillRect(z,0,1,t-11,color=(255,0,255))
        else:
            led1.fillRect(z,0,1,t,color=(255,0,255))
