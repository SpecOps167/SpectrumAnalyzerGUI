...
texture1 = image.loadImage(led1, "c:\\users\\ztech\\pictures\\bill2.jpg", offset=(0,0))
texture2 = image.loadImage(led2, "c:\\users\\ztech\\pictures\\bill2.jpg", offset=(0,-12))
led1.setTexture(tex=texture1)
led2.setTexture(tex=texture2)
led1.fillScreen(color=None)
led2.fillScreen(color=None)
led1.update()
led2.update()
raw_input("sdfasdfasfesadf")
led1.all_off()
led2.all_off()
led1.update()
led2.update()
