...
class main(object):
    ...
    def initialize(self):
        ...
        self.dropfactor = int(sys.argv[13])
    ...
    def startemu(self, option):
        ...
        o.mainloop(self.idevice, self.yshift, self.visw, self.bandc, self.logc, self.powshift, self.wscale, self.freqrange, self.chunk, i.led, self.srate, self.dropfactor)
...
class output(object):
    def mainloop(self, idevice, yshift, visw, bandc, logc, powshift, wscale, freqrange, chunk, led, srate, dropfactor):
        s = pyaudio.PyAudio()
